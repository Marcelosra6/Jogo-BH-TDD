...
func test_audio_manager_existe():
	...
	assert_has(AudioManager, "play_bala", "AudioManager debe tener play_bala")
	assert_has(AudioManager, "play_bala_enemigo", "AudioManager debe tener play_bala_enemigo")
	assert_has(AudioManager, "play_bola_enemigo", "AudioManager debe tener play_bola_enemigo")
	assert_has(AudioManager, "play_muerte_enemigo", "AudioManager debe tener play_muerte_enemigo")
	assert_has(AudioManager, "play_muerte", "AudioManager debe tener play_muerte")
