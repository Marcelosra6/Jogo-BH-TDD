...
func test_reset_game_valores_iniciales():
	...
	assert_eq(Global.enemy_vida, 100000.0,
		"reset_game debe establecer enemy_vida a 100000")
...
func test_restar_vida_enemigo_disminuye():
	...
	Global.restar_vida_enemigo(60)
	assert_eq(Global.enemy_vida, vida_inicial - 60,
		"restar_vida_enemigo debe disminuir la vida correctamente")

func test_restar_vida_enemigo_varias_veces():
	Global.reset_game()
	Global.restar_vida_enemigo(60)
	Global.restar_vida_enemigo(120)
	Global.restar_vida_enemigo(180)
	assert_eq(Global.enemy_vida, 100000.0 - 360,
		"restar_vida_enemigo debe acumular las sustracciones")

func test_restar_vida_enemigo_muerte():
	Global.reset_game()
	Global.enemy_vida = 60
	Global.restar_vida_enemigo(60)
	assert_true(Global.juego_terminado,
